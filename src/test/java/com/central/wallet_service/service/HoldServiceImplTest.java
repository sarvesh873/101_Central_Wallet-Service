...
class HoldServiceImplTest {
    ...
    private ReleaseHoldRequest releaseRequest;
    private ExtendHoldRequest extendRequest;
    private AdjustHoldRequest adjustRequest;
    ...
    void setUp() {
        ...
        releaseRequest = new ReleaseHoldRequest()
                .reason("Test release");

        extendRequest = new ExtendHoldRequest()
                .newExpiresAt(OffsetDateTime.now().plusDays(2));

        adjustRequest = new AdjustHoldRequest()
                .newAmount(150.0)
